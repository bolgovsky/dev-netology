...
Имеем : гостевая система (vagrant ubuntu20.04) и хост(windows 10).
...
### Продолжаем настройки - нужно завести SSL
...
## Страница сервера nginx в браузере хоста не содержит предупреждений - проверяем - все ОК:
